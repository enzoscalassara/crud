 ...
 * @author enzo_
 */
public class DeletarFornecedorController implements Initializable {

    private Fornecedor selected;

    public DeletarFornecedorController() {
    }

    public DeletarFornecedorController(Fornecedor selected) {
    ...
    @FXML
    void deletarFornecedor(ActionEvent event) throws SQLException, ClassNotFoundException {
        Object conexao = Main.conexao();
        
        Model.delete_bd(conexao, selected.getTabela(), selected.getID_nome(), Integer.toString(selected.getId_fornecedor()));
